...
function startPocketMaze() {
  ...
  const allMazeMaps = [
    ...
    { rows: ["#######","#P....#","###.#.#","#.K..#.","###.#.#","#....E#","#######"], shifting: [{ x: 2, y: 2 }, { x: 2, y: 3 }, { x: 4, y: 2 }] },
    { rows: ["#######","#P..#.#","#.#.#K#","#..#...","###.#.#","#....E#","#######"], shifting: [{ x: 3, y: 2 }, { x: 5, y: 2 }] },
    { rows: ["#######","#P..#.#","#.#.#K#","#..#...","###.#.#","#....E#","#######"], shifting: [{ x: 3, y: 3 }, { x: 1, y: 4 }] },
    { rows: ["#######","#P..#.#","#.#.#K#","#..#...","###.#.#","#....E#","#######"], shifting: [{ x: 5, y: 2 }, { x: 3, y: 3 }, { x: 1, y: 4 }] },
    { rows: ["#######","#P....#","###.#.#","#....K#","###.#.#","#....E#","#######"], shifting: [{ x: 2, y: 2 }, { x: 5, y: 3 }] },
    { rows: ["#######","#P....#","###.#.#","#....K#","###.#.#","#....E#","#######"], shifting: [{ x: 5, y: 3 }, { x: 3, y: 4 }] },
    { rows: ["#######","#P....#","###.#.#","#....K#","###.#.#","#....E#","#######"], shifting: [{ x: 3, y: 4 }, { x: 5, y: 3 }, { x: 2, y: 2 }] },
    { rows: ["########","#P......#","#.#.###.#","#...K.#.#","#.#.###.#","#......E","########"], shifting: [{ x: 2, y: 4 }, { x: 2, y: 2 }] },
    { rows: ["########","#P......#","#.#.###.#","#...K.#.#","#.#.###.#","#......E","########"], shifting: [{ x: 4, y: 3 }, { x: 2, y: 4 }] },
    ...
    { rows: ["#######","#P....#","#.#.#.#","#..K#..","#.#.#.#","#....E#","#######"], shifting: [{ x: 4, y: 2 }, { x: 2, y: 2 }] },
    { rows: ["#######","#P....#","#.#.#.#","#..K#..","#.#.#.#","#....E#","#######"], shifting: [{ x: 2, y: 4 }, { x: 2, y: 2 }] },
    { rows: ["#######","#P....#","#.#.#.#","#..K#..","#.#.#.#","#....E#","#######"], shifting: [{ x: 2, y: 2 }, { x: 3, y: 3 }, { x: 2, y: 4 }] },
    ...
    { rows: ["#######","#P..#.#","#.#.#.#","#..#K#.","###.#.#","#....E#","#######"], shifting: [{ x: 3, y: 2 }, { x: 5, y: 2 }] },
    { rows: ["#######","#P..#.#","#.#.#.#","#..#K#.","###.#.#","#....E#","#######"], shifting: [{ x: 5, y: 2 }, { x: 4, y: 3 }, { x: 1, y: 4 }] },
    { rows: ["#######","#P..K.#","#.#.#.#","#.....#","#.#.#.#","#..#E#.","#######"], shifting: [{ x: 4, y: 2 }, { x: 2, y: 4 }] },
    { rows: ["#######","#P..K.#","#.#.#.#","#.....#","#.#.#.#","#..#E#.","#######"], shifting: [{ x: 2, y: 2 }, { x: 2, y: 4 }] },
    { rows: ["#######","#P..K.#","#.#.#.#","#.....#","#.#.#.#","#..#E#.","#######"], shifting: [{ x: 4, y: 2 }, { x: 4, y: 4 }, { x: 2, y: 4 }] },
    ...
    { rows: ["########","#P......#","#.#.#.#.#","#..#K.#.#","#.#.#.#.#","#......E","########"], shifting: [{ x: 4, y: 3 }, { x: 6, y: 2 }] },
    { rows: ["########","#P......#","#.#.#.#.#","#..#K.#.#","#.#.#.#.#","#......E","########"], shifting: [{ x: 4, y: 3 }, { x: 4, y: 2 }] },
    { rows: ["########","#P......#","#.#.#.#.#","#..#K.#.#","#.#.#.#.#","#......E","########"], shifting: [{ x: 2, y: 2 }, { x: 6, y: 2 }, { x: 4, y: 2 }] },
    { rows: ["########","#P......#","#.#.###.#","#....K..#","#.#.###.#","#......E","########"], shifting: [{ x: 5, y: 4 }, { x: 2, y: 4 }] },
    { rows: ["########","#P......#","#.#.###.#","#....K..#","#.#.###.#","#......E","########"], shifting: [{ x: 2, y: 2 }, { x: 5, y: 2 }] },
  ...
  function pickSession() {
    mazeMaps = shuffleArray([...allMazeMaps]).slice(0, 10);
    mazeIndex = 0;
  }
  pickSession();
  let maze;
  ...
  function render() {
    ...
    document.querySelector("#mazeNumber").textContent = `Maze: ${mazeIndex + 1}/10`;
